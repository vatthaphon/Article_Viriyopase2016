...
maximize_a_fig(gcf);
% m_savefig('PINGING_IeIi_Efreq', 'eps');
...
figure(100);hold on;
plot(x_lin_correct_unit, vary_Ie_PING_freq, 'r-', 'LineWidth', 5, 'MarkerSize', 7, 'MarkerFaceColor', 'r');
plot(x_lin_correct_unit, vary_Ie_PINGING_freq, 'g-', 'LineWidth', 5, 'MarkerSize', 7, 'MarkerFaceColor', 'g');
plot(x_lin_correct_unit, vary_Ie_ING_freq, 'b-', 'LineWidth', 5, 'MarkerSize', 7, 'MarkerFaceColor', 'b');
...
maximize_a_fig(gcf);
% m_savefig('vary_Ie_freq_v2', 'eps');

figure(10000);hold on;
[AX,H1,H2] = plotyy(x_lin_correct_unit, vary_Ie_PINGING_MFR_E, x_lin_correct_unit, vary_Ie_PINGING_MFR_I , 'plot');
set(get(AX(1),'Ylabel'),'String','') 
set(get(AX(2),'Ylabel'),'String','')

set(AX(1), 'xlim', [-1.334 1.666]);
set(AX(2), 'xlim', [-1.334 1.666]);
set(AX(1), 'ylim', [-1 81]);
set(AX(2), 'ylim', [-1 81]);
axis(AX(1), 'square');
axis(AX(2), 'square');
set(AX(1),'XTick',XTickArray,'XTickLabel',XTickLabelArray);
set(AX(1), 'XMinorTick'  , 'off');
set(AX(2),'XTick',XTickArray,'XTickLabel',XTickLabelArray);
set(AX(2), 'XMinorTick'  , 'off');

set(AX(1),'YTick',[0 40 80],'YTickLabel',{'';'';''});
set(AX(2),'YTick',[0 40 80],'YTickLabel',{'';'';''});

set(H1, 'LineStyle', '-', 'LineWidth', 5, 'Color', [0 0.609 0]);
set(H2, 'LineStyle', '-', 'LineWidth', 5, 'Color', [0.6 1.0 0.6]);
...
maximize_a_fig(gcf);
% m_savefig('vary_Ie_freq_v2_MFR_E_MFR_I', 'eps');
