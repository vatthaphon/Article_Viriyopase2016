function showResultFromC_powerspectrum
clc;clear all;
% close all;
format long
...
% sub=strcat('E:\paper2_Raoul\Sim_network_of_other_people\data\nw_hh\II\IappIx_gIIGJx_Ni2\v4\data', '\');
% FN='WB_II_IappIx500_gIIGJx0.15_rndV60_dt0.05_tEnd10000_Ni2';
% tRasBegin=9500;tRasEnd=500 + 9500;E_color = 'r';I_color = 'b';

% sub=strcat('E:\paper2_Raoul\Sim_network_of_other_people\data\bw_hh\EEIEII\NWCA1_rndV_rndConn_IappI1445_1445_1626_11_Begin500_Int200\v0', '\');
% FN='BW_EEIEII_rndV0_rndConn0_IappI1521_1521_1543_11_Begin500_Int1000_dt0.01_tEnd25000';
% tRasBegin=4500;tRasEnd=5500;E_color = 'r';I_color = 'b';
...
LW = 3;
% FN='NWB_II_gIIxi3_gIIGJx0_0.01_20_41_lIIx0.6_sigmaWNI0.5_pIIGJ0.004_IappI200_rndV0_dt0.01_tEnd2000_Ni1000';LSpec='-r';
% FN='NWB_II_gIIxi3_gIIGJx3.6_0.01_20_41_lIIx0.6_sigmaWNI0.5_pIIGJ0.004_IappI200_rndV0_dt0.01_tEnd2000_Ni1000';LSpec='-g';
% FN='NWB_II_gIIxi15_gIIGJx3.6_0.01_20_41_lIIx0.6_sigmaWNI0.5_pIIGJ0.004_IappI200_rndV0_dt0.01_tEnd2000_Ni1000';LSpec='-b';
% FN='NWB_II_gIIxi22_gIIGJx3.6_0.01_20_41_lIIx0.6_sigmaWNI0.5_pIIGJ0.004_IappI200_rndV0_dt0.01_tEnd2000_Ni1000';LSpec='-k';
FN='NWB_II_gIIxi37_gIIGJx1.8_0.01_20_41_lIIx0.6_sigmaWNI0.5_pIIGJ0.004_IappI200_rndV0_dt0.01_tEnd2000_Ni1000';LSpec='-y';
tRasBegin=1000;tRasEnd=2000;E_color = 'r';I_color = 'b';

% sub=strcat('E:\paper2_Raoul\Sim_network_of_other_people\data\bw_hh\EEEIIEII\NWCA1_IappE3548.1_IappIxi_sigmaWNE60_sigmaWNI0.5\v0\data', '\');
% FN='NWCA1_BW_EEIEII_IappE3548.1_IappIxi6_1175_2170_11_sigmaWNE60_sigmaWNI0.5_rndV0_dt0.01_tEnd2000_Ni1000_Ne4000';
% tRasBegin=1950;tRasEnd=2000;E_color = 'r';I_color = 'b';
...
% FN='WB_test';tRasBegin=0;tRasEnd=200;E_color = 'r';I_color = 'b';
% FN='test_IappEx1000_IappIx1000_gsl0.05_tend200_CA3';tRasBegin=0;tRasEnd=200;E_color = 'r';I_color = 'b';

% FN='NWCA1_EEEIIEII_IappEx262.5_IappIx45_sigmaWNE20_pEI0.3_pIIGJ0.004_rndV0_dt0.01_tEnd2000_Ne4000_Ni1000';
% FN='NWCA1_EEEIIEII_IappEx250_IappIx45_sigmaWNE20_pEI0.3_pIIGJ0.004_rndV0_dt0.01_tEnd2000_Ne4000_Ni1000';

% FN='NWCA1_EEEIIEII_IappE262.5_IappI45_sigmaWNE20_pEI0.3_pIIGJ0.004_rndV0_dt0.01_tEnd2000_Ne4000_Ni1000';
% FN='NWCA1_EEEIIEII_IappE250_IappI45_sigmaWNE20_pEI0.3_pIIGJ0.004_rndV0_dt0.01_tEnd2000_Ne4000_Ni1000';

% FN='NWB_II_gIIxi4_gIIGJx0.5_0.01_20_41_sigmaWNI0_pIIGJ0.004_IappI200_rndV0_dt0.05_tEnd2000_Ni1000';
% tRasBegin=1900;tRasEnd=2000;E_color = 'r';I_color = 'b';

% FN='NWCA1_EEEIIEII_IappEx200_sigmaWNEx20_pII0.3_pIIGJ0.004_dt0.01_tEnd2000_Ne4000_Ni1000';tRasBegin=0;tRasEnd=500;E_color = 'r';I_color = 'b';
% % FN='NWCA1_EEEIIEII_IappE200_sigmaWNE20_pII0.3_pIIGJ0.004_dt0.001_tEnd500_Ne4000_Ni1000';tRasBegin=0;tRasEnd=500;E_color = 'r';I_color = 'b';


% FN='CA1HH_II_gIIGJ4_sigmaWNIx10_IappIx300_gII11.18_pII0.06_pIIGJ0.008_rndV1_dt0.01_tEnd2000_Ni5000';tRasBegin=1900;tRasEnd=2000;E_color = 'r';I_color = 'b';

% FN='HH_EIIE_RmIe_Ex30_RmIe_Ix18_sigmaWN_E10_sigmaWN_I0_dt0.01_tEnd2000';tRasBegin=0;tRasEnd=200;E_color = 'r';I_color = 'b';
% FN='HH_EIIEII_gEIx0_p_EIx1_sigmaWN_E10_dt0.01_tEnd2000';tRasBegin=0;tRasEnd=2000;E_color = 'r';I_color = 'b';
% FN='HH_II_RmIe_Ix40_pIIx0.05_dt0.01_tEnd1000_CA1';tRasBegin=0;tRasEnd=100;E_color = 'r';I_color = 'b';

% FN='test';tRasBegin=0;tRasEnd=10;E_color = 'r';I_color = 'b';
% FN='test2';tRasBegin=0;tRasEnd=500;E_color = 'r';I_color = 'b';

% FN='nonpoisson_inputs\Fig7_nonpoisson_seed1_dt0.05_tEnd10000';tRasBegin=0;tRasEnd=2000;E_color = 'r';I_color = 'b';
% FN='poisson_inputs\Fig7_seed1_dt0.01_tEnd20000';tRasBegin=0;tRasEnd=2000;E_color = 'r';I_color = 'b';

% FN='Fig7_NoPoisson_seed1_Ie35_Ii30_tEnd20000_STDLaten0';tRasBegin=0;tRasEnd=1000;I_color = 'r';
% FN='Fig7_NoPoisson_seed8_Ie85_Ii85_tEnd20000_STDLaten0';tRasBegin=0;tRasEnd=5000;I_color = 'r';
% FN='test3';tRasBegin=0;tRasEnd=500;I_color = 'r';

% FN='zhou_2010\Zhou_1.1';tRasBegin=0;tRasEnd=1000;E_color = 'b';I_color = 'r';
% FN='zhou_2010\Zhou_2.0_pert';tRasBegin=0;tRasEnd=1000;E_color = 'r';I_color = 'r';

% FN='Zhou_1.07_delay_0.10';tRasBegin=9900;tRasEnd=10000;E_color = 'b';I_color = 'r';
% FN='zhou_2010\Zhou_2.0_delay_pert';tRasBegin=0;tRasEnd=1000;E_color = 'r';I_color = 'r';

% FN='test_lin';tRasBegin=0;tRasEnd=50;E_color = 'b';I_color = 'r';
% FN='test_nonlin';tRasBegin=0;tRasEnd=50;E_color = 'r';I_color = 'r';
% FN='test';tRasBegin=0;tRasEnd=500;E_color = 'r';I_color = 'b';

% FN='Fig7_seed10_dt0.01_tEnd20000';tRasBegin=0;tRasEnd=20000;E_color = 'r';I_color = 'r';
% FN='Fig1_gamma_seed10_dt0.01_tEnd20000';tRasBegin=0;tRasEnd=20000;E_color = 'r';I_color = 'r';

% ttt = 50;ttt_length = 300;

N_LE = 2;tShowLEPert = 100;

LSpec_max_connected_I   = 'bx';
LSpec_min_connected_I   = 'b-';
LSpec_max_connected_E   = 'rx';
LSpec_min_connected_E   = 'r-';

isShowRastergram    = 1;isSaveRastergram = 0;FNSaveRastergram = FN;
isShowPopCohMeasure = 0;
isShowMFR           = 0;isShowMFRFig = 0;
isComputeTimeLag    = 0;isShowComputeTimeLag=0;
isShowFreqEachPop   = 0;isShowFreqEachFig = 1;
isShowProbabilityDischarge = 0;
isShowFreq          = 1;isShowFreqFig = 1;max_power_tol_percent = 20;N_repeat_Activity = 0;
isShowSynIndex      = 0;
isShowVtraj         = 0;isShowVtrajFigure = 1;isShowVtrajZoom = 1;
isShowLE            = 0;
isShowLEEnd         = 0;
isSaveVtrajLE       = 0;
isCalEndPertLE      = 0;
...
LineS = '-';
isShowAllOsc = 1;
vert_bar_size = 0.1*3.0*10.0*0.9;
isShowPattSeq = 1;
...
if (0 <= fileID)
    ...
    [wb_V wb_h wb_n pyr_V pyr_h_NaT pyr_m_CaT pyr_h_CaT pyr_m_CaH ...
        h_CaH m_KDR h_KDR m_KM N_i N_e dt Nt SpkProfile ...
        p_EE p_EI p_IE p_II tau_m_on_E tau_m_on_I RmIe_E RmIe_I] = ...
        get_necessary_Data(Data);
...
%     tSimEnd             = dt*(Nt-1);
    ...
    display('Parameters:');
    display(strcat('- tSimBegin=', num2str(tSimBegin),', tSimEnd=', num2str(tSimEnd)));
else
...
if (isShowPopCohMeasure == 1)
    display(strcat('Population Coherence measure:'));
    rand('seed', 1);
    ...
    if (N_i > 0)
        ...
        for I_id = 1:N_i
            ...
            if (I_id == 1)
                if (0 < (rows(I_id,1) - 1))
                    first_spk_times = SpkProfile(1:(rows(I_id,1)-1),1);
                    index=(tSimBegin <= first_spk_times) & (first_spk_times <= tSimEnd);
                    first_spk_times = first_spk_times(index, 1);
                end
            else
                if ((rows(I_id-1,1) + 1) <= (rows(I_id,1) - 1))
                    first_spk_times = SpkProfile((rows(I_id-1,1)+1):(rows(I_id,1)-1),1);
                    index=(tSimBegin <= first_spk_times) & (first_spk_times <= tSimEnd);
                    first_spk_times = first_spk_times(index, 1);
                end
            end
            ...
            n_spk_times(I_id, :) = n_first_spk_times;
        end
        
        sum_n_spk_times = sum(n_spk_times');
        sum_n_spk_times = sqrt(sum_n_spk_times');
        
        n_cols = size(n_spk_times, 2);
        sum_n_spk_times = repmat(sum_n_spk_times, 1, n_cols);
        
        n_spk_times = n_spk_times./sum_n_spk_times;
        
        kappa_ij = n_spk_times*n_spk_times';
        kappa_ij(isnan(kappa_ij) == 1) = 0;
        
        kappa_I = mean(mean(kappa_ij));
    else
    ...
    if (N_e > 0)
        ...
        for I_id = (1 + N_i):(N_e + N_i)
            ...
            n_spk_times(I_id - N_i, :) = n_first_spk_times;
        end
        ...
        kappa_E = mean(mean(kappa_ij));
    else
        kappa_E = 0;
    end
    
    display(strcat('- E-cells:',num2str(kappa_E)));
    display(strcat('- I-cells:',num2str(kappa_I)));
end
...
if (isShowMFR == 1)
    ...
    if (isShowMFRFig == 1)
        ...
        %         plot(xout_E,n_E,'r');
        bar(xout_E,n_E,'r');
        xlabel('[Hz]');ylabel('Fraction of cells');title('Firing rate [Hz] of E individual neurons');
        axis tight
        ...
        %         plot(xout_I,n_I,'b');
        bar(xout_I,n_I,'b');
        xlabel('[Hz]');ylabel('Fraction of cells');title('Firing rate [Hz] of I individual neurons');
        axis tight
        xlim([tMFRBegin tMFREnd]);
        id = id + 1;
...
if (isShowFreqEachPop == 1)
    ...
    %% Freq. for each of population
    I_R_t = hist(I_spike_times,[tSimBegin:resolution_dt:tSimEnd]);
    E_R_t = hist(E_spike_times,[tSimBegin:resolution_dt:tSimEnd]);
    
    I_R_t = I_R_t/(N_i*resolution_dt*1e-3);   % [Hz]
    E_R_t = E_R_t/(N_e*resolution_dt*1e-3);   % [Hz]
    ...
    f       = Fs/2*linspace(0,1,NFFT/2+1);              % freq.
    
    I_Y     = fft(I_R_t-mean(I_R_t),NFFT)/L;
    E_Y     = fft(E_R_t-mean(E_R_t),NFFT)/L;
    
    I_power_Y = 2*abs(I_Y(1:NFFT/2+1));                     % corresponding power of freq.
    E_power_Y = 2*abs(E_Y(1:NFFT/2+1));                     % corresponding power of freq.
    
    I_peak = 1 + find(I_power_Y(1, 2:end-1) > I_power_Y(1, 1:end-2) & I_power_Y(1, 2:end-1) >= I_power_Y(1, 3:end));    % determine all existing peaks of power
    E_peak = 1 + find(E_power_Y(1, 2:end-1) > E_power_Y(1, 1:end-2) & E_power_Y(1, 2:end-1) >= E_power_Y(1, 3:end));    % determine all existing peaks of power
    
    % For the I-cells
    display('Cal. Freq. of the I-cells:');
    I_peak_f = f(1, I_peak);
    I_peak_power_Y = I_power_Y(1, I_peak);
    
    [max_power, I] = max(I_peak_power_Y);
    good_power = ((max_power - max_power*max_power_tol_percent/100) <= I_peak_power_Y);
    display(strcat('- Range:',num2str((max_power - max_power*max_power_tol_percent/100)), '<='));
    
    tmp = I_peak_f(1, good_power);
    if (0 < size(tmp, 2))
        good_peak_f = tmp(1, 1);
        T_for_ComputeTimeLag = 1000/good_peak_f;
        display(strcat('- Freq.:', num2str(good_peak_f), ' Hz (T =', num2str(T_for_ComputeTimeLag), ' ms.)'));
        
        tmp = I_peak_power_Y(1, good_power);
        power_rhythm = tmp(1,1);
        display(strcat('- Power:', num2str(power_rhythm)));
    else
        display(strcat('- Freq.: NaN'));
        display(strcat('- Power: NaN'));
    end
    
    
    % For the E-cells
    display('Cal. Freq. of the E-cells:');
    E_peak_f = f(1, E_peak);
    E_peak_power_Y = E_power_Y(1, E_peak);
    
    [max_power, I] = max(E_peak_power_Y);
    good_power = ((max_power - max_power*max_power_tol_percent/100) <= E_peak_power_Y);
    display(strcat('- Range:',num2str((max_power - max_power*max_power_tol_percent/100)), '<='));
    
    tmp = E_peak_f(1, good_power);
    if (0 < size(tmp, 2))
        good_peak_f = tmp(1, 1);
        T_for_ComputeTimeLag = 1000/good_peak_f;
        display(strcat('- Freq.:', num2str(good_peak_f), ' Hz (T =', num2str(T_for_ComputeTimeLag), ' ms.)'));
        
        tmp = E_peak_power_Y(1, good_power);
        power_rhythm = tmp(1,1);
        display(strcat('- Power:', num2str(power_rhythm)));
    else
        display(strcat('- Freq.: NaN'));
    ...
    if (isShowFreqEachFig == 1)
        ...
        ylabel_txt = 'Spiking Oscillators';
...
if (isShowFreq == 1)
    ...
    tSimBeginShowFreq = tSimBegin;
    tSimEndShowFreq = tSimEnd;
    
    tmp_all_spike_times = all_spike_times;
    for i_N_repeat_Activity = 1:1:N_repeat_Activity
        tmp_all_spike_times = [tmp_all_spike_times; i_N_repeat_Activity.*(tSimEnd - tSimBegin) + all_spike_times];
        
        tSimEndShowFreq = tSimEndShowFreq + (tSimEnd - tSimBegin);
    end
    all_spike_times = tmp_all_spike_times;
    
    R_t=hist(all_spike_times,[tSimBeginShowFreq:resolution_dt:tSimEndShowFreq]); % Initialize the instantaneous firing rate with 'resolution_dt' small bins.
    R_t=R_t/(N_oscs*resolution_dt*1e-3);   % [Hz]
    
    N_x_t=size([tSimBeginShowFreq:resolution_dt:tSimEndShowFreq],2);
    t = [tSimBeginShowFreq:resolution_dt:tSimEndShowFreq];
    ...
    f       = Fs/2*linspace(0,1,NFFT/2+1);              % freq.
    power_Y = 2*abs(Y(1:NFFT/2+1));                     % corresponding power of freq.
    
    peak = 1 + find(power_Y(1, 2:end-1) > power_Y(1, 1:end-2) & power_Y(1, 2:end-1) >= power_Y(1, 3:end));    % determine all existing peaks of power
    
    peak_f = f(1, peak);
    peak_power_Y = power_Y(1, peak);
    
    [max_power, I] = max(peak_power_Y);
    good_power = ((max_power - max_power*max_power_tol_percent/100) <= peak_power_Y);
    display(strcat('- Range:',num2str((max_power - max_power*max_power_tol_percent/100)), '<='));
    
    tmp = peak_f(1, good_power);
    good_peak_f = tmp(1, 1);
    T_for_ComputeTimeLag = 1000/good_peak_f;
    display(strcat('- Freq.:', num2str(good_peak_f), ' Hz (T =', num2str(T_for_ComputeTimeLag), ' ms.)'));
    
    tmp = peak_power_Y(1, good_power);
    power_rhythm = tmp(1,1);
    display(strcat('- Power:', num2str(power_rhythm)));
    
    display(strcat('- Stationary firing rate:',num2str(mean(mean(R_t))),' Hz'));
    
    Rhythm_certainty = (power_rhythm - mean(mean(power_Y)))/power_rhythm;
    display(strcat('- Rhythm certainty:',num2str(Rhythm_certainty)));
...
%         subplot(row,col,id);hold on;
        figure(31);hold on
        plot(f, power_Y,LSpec,'LineWidth', LW)    % Plot single-sided amplitude spectrum.
%         plot(peak_f, peak_power_Y, 'r*')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if ((isComputeTimeLag == 1) && (isShowFreq == 1))
    ...
    %
    %     [max_power, I] = max(peak_power_Y);
    %     good_power = ((max_power - max_power*max_power_tol_percent_ComputeTimeLag/100) <= peak_power_Y);
    %
    %     tmp = peak_f(1, good_power);
    %
    %     T = 1000/tmp(1,1);
    
    T = T_for_ComputeTimeLag;
    ...
    if (0 <= fileID)
        ...
        if (A ~= 0)
            ...
            if (isShowVtrajZoom == 1)
                %                 figure(figure_id);hold on
                %                 plot(t_lin,I_syn_from_E_ext_input_max_connected_I);
                %
                %                 figure_id=figure_id+1;
                %
                figure(figure_id);hold on
                ...
                if ((0 < N_i) && (0 < N_e))
                    %                     subplot(2,1,1)
                    % %                     plot(t_lin,V_max_connected_E,'-r',t_lin,V_min_connected_E,'-.r');
                    %                     plot(t_lin,V_max_connected_E,'-r');
                    %                     grid on
                    %
                    %                     subplot(2,1,2)
                    % %                     plot(t_lin,V_max_connected_I,'b',t_lin,V_min_connected_I,'-.b');
                ...
                elseif (0 < N_i)
                    plot(t_lin,V_max_connected_I,'b',t_lin,V_min_connected_I,'-.r');
                    
                    %                     duration = max(t_lin) - min(t_lin);
                    %                     hold on
                    %                     plot((t_lin - min(t_lin))/duration,V_max_connected_I,'-.r');
                    
                    grid on
                elseif (0 < N_e)
                    plot(t_lin,V_max_connected_E,'-r',t_lin,V_min_connected_E,'-.r');
                    
                    mean(V_max_connected_E(:, 1))
                    
                    grid on
                end
                %                 save(FN, 't_lin', ...
                %                     'V_max_connected_I', 'V_min_connected_I', ...
                %                     'I_syn_from_E_max_connected_I', 'I_syn_from_E_min_connected_I', ...
                %                     'I_syn_from_I_max_connected_I', 'I_syn_from_I_min_connected_I');
                figure_id=figure_id+1;
                %
                %                 figure(figure_id);hold on
                %                 plot(t_lin,I_syn_from_I_max_connected_I);
                %
                %
                %                 figure_id=figure_id+1;
            end
...
function [wb_V wb_h wb_n pyr_V pyr_h_NaT pyr_m_CaT pyr_h_CaT pyr_m_CaH h_CaH m_KDR h_KDR m_KM N_i N_e dt Nt SpkProfile p_EE p_EI p_IE p_II tau_m_on_E tau_m_on_I RmIe_E RmIe_I] = get_necessary_Data(Data)
% %%
% cnt=1;
%
...
V_th=Data(cnt,1);cnt=cnt+2;
V_reset=Data(cnt,1);cnt=cnt+2;
V_refrac_e=Data(cnt,1);cnt=cnt+2;
tau_m=Data(cnt,1);cnt=cnt+2;
C_m_E=Data(cnt,1);cnt=cnt+2;

V_rest=Data(cnt,1);cnt=cnt+2;
V_th=Data(cnt,1);cnt=cnt+2;
V_reset=Data(cnt,1);cnt=cnt+2;
V_refrac_i=Data(cnt,1);cnt=cnt+2;
tau_m=Data(cnt,1);cnt=cnt+2;
C_m_I=Data(cnt,1);cnt=cnt+2;
...
%     wb_V=Data(cnt,1);cnt=cnt+2;
%     wb_h=Data(cnt,1);cnt=cnt+2;
%     wb_n=Data(cnt,1);cnt=cnt+2;
%
%     if ((0 <= wb_V) && (1 <= wb_h) && (1 <= wb_n))
%         % Old format
%         display('Old format data set:');
%
%         cnt=cnt-2;
%         cnt=cnt-2;
%         cnt=cnt-2;
...
%     else
%         % New format
%         display('New format data set:');
%
%         pyr_V=Data(cnt,1);cnt=cnt+2;
%         pyr_h_NaT=Data(cnt,1);cnt=cnt+2;
%         pyr_m_CaT=Data(cnt,1);cnt=cnt+2;
%         pyr_h_CaT=Data(cnt,1);cnt=cnt+2;
%         pyr_m_CaH=Data(cnt,1);cnt=cnt+2;
%         h_CaH=Data(cnt,1);cnt=cnt+2;
%         m_KDR=Data(cnt,1);cnt=cnt+2;
%         h_KDR=Data(cnt,1);cnt=cnt+2;
%         m_KM=Data(cnt,1);cnt=cnt+2;
%
%         wb_V=Data(cnt,1);cnt=cnt+2;
%         wb_h=Data(cnt,1);cnt=cnt+2;
%         wb_n=Data(cnt,1);cnt=cnt+2;
...
%% Display
display('Hippocampus properties:');
display(strcat('- N_e:', num2str(N_e)));
display(strcat('- N_i:', num2str(N_i)));
display(strcat('- Ref_e:', num2str(V_refrac_e)));
display(strcat('- Ref_i:', num2str(V_refrac_i)));
display(strcat('- tau_m_E:', num2str(tau_m_on_E)));
display(strcat('- tau_m_I:', num2str(tau_m_on_I)));

display(strcat('- pEE:', num2str(p_EE), ',gEE:', num2str(g_syn_AMPA_on_E)));
display(strcat('- pEI:', num2str(p_EI), ',gEI:', num2str(g_syn_AMPA_on_I)));
display(strcat('- pIE:', num2str(p_IE), ',gIE:', num2str(g_syn_GABA_on_E)));
display(strcat('- pII:', num2str(p_II), ',gII:', num2str(g_syn_GABA_on_I)));

display(strcat('- EE:delay=', num2str(tau_l_AMPA_on_E), ',rise=', num2str(tau_r_AMPA_on_E), ',decay=', num2str(tau_d_AMPA_on_E)));
display(strcat('- EI:delay=', num2str(tau_l_AMPA_on_I), ',rise=', num2str(tau_r_AMPA_on_I), ',decay=', num2str(tau_d_AMPA_on_I)));
display(strcat('- IE:delay=', num2str(tau_l_GABA_on_E), ',rise=', num2str(tau_r_GABA_on_E), ',decay=', num2str(tau_d_GABA_on_E)));
display(strcat('- II:delay=', num2str(tau_l_GABA_on_I), ',rise=', num2str(tau_r_GABA_on_I), ',decay=', num2str(tau_d_GABA_on_I)));

display(strcat('- RmIe_E:', num2str(RmIe_E)));
display(strcat('- RmIe_I:', num2str(RmIe_I)));

display(strcat('- Ie_E:', num2str(RmIe_E/(tau_m_on_E/C_m_E))));
display(strcat('- Ie_I:', num2str(RmIe_I/(tau_m_on_I/C_m_I))));

display('I-Cell properties:');
display(strcat('- wb_V:', num2str(wb_V)));
display(strcat('- wb_h:', num2str(wb_h)));
display(strcat('- wb_n:', num2str(wb_n)));

display('E-Cell properties:');
display(strcat('- pyr_V:', num2str(pyr_V)));
display(strcat('- pyr_h_NaT:', num2str(pyr_h_NaT)));
display(strcat('- pyr_m_CaT:', num2str(pyr_m_CaT)));
display(strcat('- pyr_h_CaT:', num2str(pyr_h_CaT)));
display(strcat('- pyr_m_CaH:', num2str(pyr_m_CaH)));
display(strcat('- h_CaH:', num2str(h_CaH)));
display(strcat('- m_KDR:', num2str(m_KDR)));
display(strcat('- h_KDR:', num2str(h_KDR)));
display(strcat('- m_KM:', num2str(m_KM)));
