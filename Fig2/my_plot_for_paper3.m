...
for rndV = 0:1:(N_rndV - 1)
    ...
    dir = 'E:\paper2_Raoul\Sim_network_of_other_people\data\hh\II\NWB_gIIxi_gIIGJx_0.01_20_41_sigmaWNI0.5_IappI200\v1\';
    load(strcat(dir,strcat(Perc, '.mat')))
    
    tmp_PowerFreq_dt = reshape(PowerFreq_dt(:, 1), N_y, N_x)';
    tmp_Freq_dt = reshape(Freq_dt(:, 1), N_y, N_x)';
%     tmp_PowerFreq_dt = reshape(E_PowerFreq_dt(:, 1), N_y, N_x)';
%     tmp_Freq_dt = reshape(E_Freq_dt(:, 1), N_y, N_x)';
