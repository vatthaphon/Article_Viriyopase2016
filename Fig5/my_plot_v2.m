...
dir = 'C:\paper2_Raoul\Sim_network_of_other_people\data\bw_hh\EEEIIEII\NWCA1_IappEx_sigmaWNEx_IappI0\v9\data\';
...
maximize_a_fig(gcf);
% m_savefig('IappE_vs_SigmaWNE_Freq_type2_v2', 'eps');
...
maximize_a_fig(gcf);
% m_savefig('IappE_vs_SigmaWNE_MFRe_Type2_v2', 'eps');
...
maximize_a_fig(gcf);
% m_savefig('IappE_vs_SigmaWNE_MFRi_Type2_v2', 'eps');
