...
plot(y_lin_correct_unit, vary_Ii_PINGING_freq + 0.1, 'g', 'LineWidth', 5, 'MarkerSize', 7, 'MarkerFaceColor', 'g');
plot(y_lin_correct_unit, vary_Ii_PING_freq, 'r', 'LineWidth', 5, 'MarkerSize', 7, 'MarkerFaceColor', 'r');
plot(y_lin_correct_unit, vary_Ii_ING_freq, 'b', 'LineWidth', 5, 'MarkerSize', 7, 'MarkerFaceColor', 'b');
...
% m_savefig('vary_Ii_freq_SigmaI0_5_for_paper2_Fixed_Ie_2', 'eps');
...
Fixed_Ie = 2.0;
Fixed_Ii = 0.85;
% m_savefig('vary_Ie_freq_SigmaI0_5_for_paper2_Fixed_Ii_0_85', 'eps');
