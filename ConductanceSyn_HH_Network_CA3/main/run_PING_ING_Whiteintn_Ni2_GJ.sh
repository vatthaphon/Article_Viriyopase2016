...
if ($host eq "patron")
{	
$mjob_file = "./mjob_RAP_patron_WHITE_WB.sh";
$store_dir = "/local/";      
}
else
{
$mjob_file = "./mjob_RAP_WHITE_WB.sh";
...
#$begin_Val1			=-99.379;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
#$begin_Val1			=4336.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
#$begin_Val1			=127.0;$end_Val1		=321.0;$len_Val1			=11;
#$begin_Val1			=-150.0;$end_Val1		=5000.0;$len_Val1			=11;
$begin_Val1			=0.01;$end_Val1		=1800.0;$len_Val1		=11;$is_Iapp_I_linear = 0;
...
#$begin_Val35		=4.51725;$end_Val35		=$begin_Val35;$len_Val35	=1;
#$begin_Val35		=0.0;$end_Val35		=4.0;$len_Val35				=11;
$begin_Val35		=0.0;$end_Val35		=2.0;$len_Val35				=11;
...
$begin_Val11	=0;$end_Val11	=100;$len_Val11	=101;
...
#$FN=$REG_TAG."II_IappIx${Iapp_I}_gIIGJ${val35}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";

$FN=$REG_TAG."II_IappIxi${i}_gIIGJx${val35}_${begin_Val1}_${end_Val1}_${len_Val1}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
...
####################### Send commands #######################	
	...
	else
	{
		...
		if ($wait2see == 1)
		{
			...
			$cmd="./hh_network_PING_ING_WHITE_WB \"$MYFLAG_STR\" ";			
			system($cmd);
			#while (!(-e $done))
			#{
				#	sleep(1);
		...
		else
		{
			...
			$cmd="nohup nice -n 19 ./hh_network_PING_ING_WHITE_WB \"$MYFLAG_STR\" >nohup\"$done\".out 2>&1 &";			
			system($cmd);
		}
