...
$FN=$REG_TAG."BW_EEEIIEII_IappEx${Iapp_E}_sigmaWNEx${sigma_white_noise_E}_tauDIE${tau_d_GABA_on_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
