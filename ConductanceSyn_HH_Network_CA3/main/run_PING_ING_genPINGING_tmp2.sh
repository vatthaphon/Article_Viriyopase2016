...
$begin_Val1			=144.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
...
#$begin_Val14		=0.0;$end_Val14=$begin_Val14;$len_Val14=1;
$begin_Val14		=0.0;$end_Val14			=1.845;$len_Val14		=11;
...
$FN=$REG_TAG."EEEIIEII_gEIx${g_syn_AMPA_on_I}_pEI${p_EI}_IappI${Iapp_I}_IappE${Iapp_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
