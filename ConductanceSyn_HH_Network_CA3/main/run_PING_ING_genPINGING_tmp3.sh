...
#$begin_Val16		=0.0;$end_Val16		=1000.0;$len_Val16	=41;$is_hetero_Ie_E = 1;

######## Iapp_I, [Iapp_I] = pA
$is_Iapp_I_linear = 1;
#$begin_Val1			=0.0;$end_Val1		=$begin_Val1;$len_Val1		=1;
#$begin_Val1			=144.552;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
#$begin_Val1			=127.0;$end_Val1		=321.0;$len_Val1			=11;
$begin_Val1			=130.0;$end_Val1		=200.0;$len_Val1			=11;
...
#$begin_Val14		=0.0;$end_Val14=$begin_Val14;$len_Val14=1;
#$begin_Val14		=0.0;$end_Val14			=6.150;$len_Val14		=101;
...
#$FN=$REG_TAG."EEEIIEII_IappIx${Iapp_I}_pEI${p_EI}_gEI${g_syn_AMPA_on_I}_IappE${Iapp_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEEIIEII_gEIx${g_syn_AMPA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
...
$FN=$REG_TAG."II_IappIx${Iapp_I}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
