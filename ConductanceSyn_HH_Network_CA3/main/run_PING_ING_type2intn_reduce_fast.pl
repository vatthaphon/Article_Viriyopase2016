...
$begin_Val23		=0.15;$end_Val23		=$begin_Val23;$len_Val23	=1;
...
$g_syn_AMPA_on_E=($g_syn_AMPA_on_E*$N_pyr_sim*$tmp_p_EE*3.0)/$Gamma_freq;
...
#$FN=$REG_TAG."test_biexp_normal";
$FN=$REG_TAG."test_biexp_fast";
