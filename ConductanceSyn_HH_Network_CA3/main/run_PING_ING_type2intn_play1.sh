...
$begin_Val13		=1000.0;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
...
#$begin_Val13		=2160.0;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
...
#$begin_Val13		=0.0;$end_Val13		=10000.0;$len_Val13			=11;				
...
#$begin_Val1			=1300.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
#$begin_Val1			=1175.0;$end_Val1		=2170.0;$len_Val1			=41;
#$begin_Val1			=1400.0;$end_Val1		=1700.0;$len_Val1			=41;
#$begin_Val1			=1175.0;$end_Val1		=1770.0;$len_Val1			=41;
#$begin_Val1			=1100.0;$end_Val1		=1800.0;$len_Val1			=11;
#$begin_Val1			=1163.0;$end_Val1		=1170.0;$len_Val1			=41;
...
$begin_Val17		=0.1;$end_Val17	=150.0;$len_Val17			=41;$is_use_sigma_white_noise=1;$is_sigmaWNE_linear = 0;

######## sigma_white_noise_I
$begin_Val12		=0.0;$end_Val12		=$begin_Val12;$len_Val12	=1;
#$begin_Val12		=2.0;$end_Val12	=$begin_Val12;$len_Val12	=1;$is_use_sigma_white_noise=1;
#$begin_Val12		=0.5;$end_Val12	=$begin_Val12;$len_Val12	=1;$is_use_sigma_white_noise=1;
#$begin_Val12		=0.0;$end_Val12		=0.5;$len_Val12			=11;$is_use_sigma_white_noise=1;
...
if ($is_sigmaWNE_linear == 0)
{
$val17 = $begin_Val17*(($end_Val17/$begin_Val17)**($y/($len_Val17 - 1.0)));
}
else
{
...
#$FN=$REG_TAG."BW_EEEIIEII_sigmaWNEx${sigma_white_noise_E}_sigmaWNIx${sigma_white_noise_I}_IappE${Iapp_E}_IappIx${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEEIIEII_IappEx${Iapp_E}_sigmaWNEx${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

$FN=$REG_TAG."BW_EEEIIEII_sigmaWNExi${y}_${begin_Val17}_${end_Val17}_${len_Val17}_sigmaWNI${sigma_white_noise_I}_IappE${Iapp_E}_IappIx${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEEIIEII_sigmaWNExi${y}_sigmaWNIx${sigma_white_noise_I}_${begin_Val17}_${end_Val17}_${len_Val17}_IappE${Iapp_E}_IappIx${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
...
#$FN=$REG_TAG."BW_II_IappIx${Iapp_I}_rndVx${rnd_init_V}_sigmaWNI${sigma_white_noise_I}_rnd_Conns${rnd_determineConnections}_incIinput0_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_II_IappIx${Iapp_I}_gIIGJx${g_syn_II_gap_junction}_sigmaWNI${sigma_white_noise_I}_incIinput0_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_II_IappIx${Iapp_I}_gIIGJx${g_syn_II_gap_junction}_rndVx${rnd_init_V}_rnd_Conns${rnd_determineConnections}_sigmaWNI${sigma_white_noise_I}_incIinput0_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
