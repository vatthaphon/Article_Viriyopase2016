...
$FN=$REG_TAG."EEEIIEII_PING_gIEx${g_syn_GABA_on_E}_gIIx${g_syn_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
