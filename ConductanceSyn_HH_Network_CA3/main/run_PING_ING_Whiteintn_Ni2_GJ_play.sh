...
$begin_Val1			=1800.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
...
$begin_Val35		=1.1;$end_Val35		=$begin_Val35;$len_Val35	=1;
...
$begin_Val11	=0;$end_Val11	=1000;$len_Val11	=1001;
...
$FN=$REG_TAG."II_IappI${Iapp_I}_gIIGJ${val35}_rndVx${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
