...
$begin_Val1			=190.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
#$begin_Val1			=0.0;$end_Val1		=500.0;$len_Val1			=11;
...
$begin_Val17		=25.0;$end_Val17	=$begin_Val17;$len_Val17	=1;$is_use_sigma_white_noise=1;
#$begin_Val17		=15.0;$end_Val17	=$begin_Val17;$len_Val17	=1;$is_use_sigma_white_noise=1;
#$begin_Val17		=20.5;$end_Val17		=25.0;$len_Val17			=10;$is_use_sigma_white_noise=1;

######## sigma_white_noise_I
$is_sigmaWNI_linear = 1;
#$begin_Val12		=0.0;$end_Val12		=$begin_Val12;$len_Val12	=1;
$begin_Val12		=0.8;$end_Val12	=$begin_Val12;$len_Val12	=1;$is_use_sigma_white_noise=1;
...
#$begin_Val37	=100.0;$end_Val37=$begin_Val37;$len_Val37=1;
...
#$FN=$REG_TAG."EEIEII_IappIx${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_IappE${Iapp_E}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
#$FN=$REG_TAG."EEEIIEII_IappIx${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_IappE${Iapp_E}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";

$FN=$REG_TAG."EEIEII_IappEx${Iapp_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_IappI${Iapp_I}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
#$FN=$REG_TAG."EEEIIEII_IappEx${Iapp_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_IappI${Iapp_I}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
