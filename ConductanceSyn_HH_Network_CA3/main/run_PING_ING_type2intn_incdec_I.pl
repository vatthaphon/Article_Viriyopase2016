...
$begin_Val1			=1521.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
...
#$begin_Val37	=5000.0;$end_Val37=$begin_Val37;$len_Val37=1;
#$begin_Val37	=10000.0;$end_Val37=$begin_Val37;$len_Val37=1;
#$begin_Val37	=15000.0;$end_Val37=$begin_Val37;$len_Val37=1;
#$begin_Val37	=20000.0;$end_Val37=$begin_Val37;$len_Val37=1;
#$begin_Val37	=25000.0;$end_Val37=$begin_Val37;$len_Val37=1;
$begin_Val37	=45000.0;$end_Val37=$begin_Val37;$len_Val37=1;
#$begin_Val37	=70000.0;$end_Val37=$begin_Val37;$len_Val37=1;
...
# Random numbers
$rnd_init_V = $val11;
$rnd_determineConnections = $val42;
...
#$FN=$REG_TAG."I0_I_begin1670_I0_I_end1872_I0_I_N11_I0_I_t_begin500_I0_I_t_int200_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
#$FN=$REG_TAG."IappI${Iapp_I}_I0_I_begin1751_I0_I_end1811_I0_I_N11_I0_I_t_begin200_I0_I_t_int1000_dt${dt}_tEnd${tEnd}";
#$FN=$REG_TAG."rndVx${rnd_init_V}_rndConnx${rnd_determineConnections}_IappI${Iapp_I}_1770_1810_11_Begin1000_Int1000_dt${dt}_tEnd${tEnd}";
#$FN=$REG_TAG."I0_I_t_begin500_I0_I_t_int200_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
...
$FN=$REG_TAG."EEIEII_rndV${rnd_init_V}_rndConn${rnd_determineConnections}_IappI${Iapp_I}_1521_1543_11_Begin500_Int2000_dt${dt}_tEnd${tEnd}";
...
####################### Send commands #######################
	...
	else
	{
		...
		if ($wait2see == 1)
		{
			$cmd="./hh_network_PING_ING_BW_incdec_I \"$MYFLAG_STR\" ";
			system($cmd);
		}
		else
		{
			$cmd="nohup nice -n 19 ./hh_network_PING_ING_BW_incdec_I \"$MYFLAG_STR\" >nohup\"$done\".out 2>&1 &";
			system($cmd);
		}
