...
#$I_firing_rate = 38.09; #Hz
#$E_firing_rate = 0.88; #Hz
#$E_firing_rate = 2.42; #Hz
#$Gamma_freq = 38.66; #Hz

$I_firing_rate = 35.9; #Hz
$E_firing_rate = 0.88;	#Hz
$Gamma_freq = 41.99; #Hz

$FN="ING";
$N_e=ceil(($E_firing_rate/$Gamma_freq)*$N_pyr_sim);
$N_i=ceil(($I_firing_rate/$Gamma_freq)*$N_basket_sim);
...
#$begin_Val1			=153.6;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
#$begin_Val1			=180.69;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
