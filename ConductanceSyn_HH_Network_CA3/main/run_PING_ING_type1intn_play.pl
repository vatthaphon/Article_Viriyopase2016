...
#$store_dir = "/vol/neuroinf2/viriyopa/scratch/nodel/";	
...
$begin_Val13		=431.8;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
#$begin_Val13		=425.0;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
#$begin_Val13		=500.0;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
#$begin_Val13		=0.0;$end_Val13		=500.0;$len_Val13			=11;				
...
#$begin_Val16		=0.0;$end_Val16		=1000.0;$len_Val16	=11;$is_hetero_Ie_E = 1;

######## Iapp_I, [Iapp_I] = pA
$is_Iapp_I_linear = 1;
#$begin_Val1			=0.0;$end_Val1		=$begin_Val1;$len_Val1		=1;
$begin_Val1			=180.6;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
#$begin_Val1			=210.8;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
#$begin_Val1			=216.82;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
...
#$begin_Val1			=108.0;$end_Val1		=253.0;$len_Val1			=41;

#$begin_Val1			=108.0;$end_Val1		=350.0;$len_Val1			=41;

#$begin_Val1			=1000.0;$end_Val1		=4370.0;$len_Val1		=11;$is_Iapp_I_linear = 0;
...
#$begin_Val4			=0.0;$end_Val4		=200.0;$len_Val4	=11;$is_hetero_Ie_I = 1;
#$begin_Val4			=0.01;$end_Val4		=200.0;$len_Val4	=11;$is_hetero_Ie_I = 1;$is_sigmaIi_linear = 0;
...
#$begin_Val5			=0.001;$end_Val5=$begin_Val5;$len_Val5=1;
...
#$begin_Val30		=0.001;$end_Val30		=$begin_Val30;$len_Val30	=1;
...
#$begin_Val17		=20.0;$end_Val17	=$begin_Val17;$len_Val17	=1;$is_use_sigma_white_noise=1;
#$begin_Val17		=21.0;$end_Val17		=25.0;$len_Val17			=5;$is_use_sigma_white_noise=1;

######## sigma_white_noise_I
$is_sigmaWNI_linear = 1;
...
$begin_Val12		=0.7;$end_Val12	=$begin_Val12;$len_Val12	=1;$is_use_sigma_white_noise=1;
#$begin_Val12		=0.0;$end_Val12		=5.0;$len_Val12			=41;$is_use_sigma_white_noise=1;$is_sigmaWNI_linear = 0;
#$begin_Val12		=0.1;$end_Val12		=10.0;$len_Val12			=11;$is_use_sigma_white_noise=1;$is_sigmaWNI_linear = 0;
...
#$begin_Val14		=6.150*$p_EI*4000.0*1.58/40.0;$end_Val14	=$begin_Val14;$len_Val14	=1;	# Default gEI
#$begin_Val14		=6.150*$p_EI*4000.0*0.88/41.99;$end_Val14	=$begin_Val14;$len_Val14	=1;	# Default gEI
#$begin_Val14		=0.0;$end_Val14=$begin_Val14;$len_Val14=1;
#$begin_Val14		=0.0;$end_Val14			=12.0;$len_Val14		=6;
#$begin_Val14		=0.01;$end_Val14			=6.150*2.0;$len_Val14		=11;$is_gEI_linear = 0;	

######## g_syn_GABA_on_E, gI->E
$begin_Val15		=24.06;$end_Val15	=$begin_Val15;$len_Val15	=1;	# Default gIE
#$begin_Val15		=20.0;$end_Val15=$begin_Val15;$len_Val15=1;	# Bal.
...
#$begin_Val15		=10.0;$end_Val15		=30.0;$len_Val15		=11;	

######## g_syn_GABA_on_I, gI->I
$is_gII_linear = 1;
$begin_Val2			=11.18;$end_Val2	=$begin_Val2;$len_Val2		=1;	# Default gII
#$begin_Val2			=11.18*0.3*50.0*35.9/41.99;$end_Val2	=$begin_Val2;$len_Val2		=1;	# Default gII
#$begin_Val2			=11.18*$p_EI*1000.0*36.77/40.0;$end_Val2	=$begin_Val2;$len_Val2		=1;	# Default gII
#$begin_Val2			=11.18*$p_EI*1000.0*35.9/41.99;$end_Val2	=$begin_Val2;$len_Val2		=1;	# Default gII
#$begin_Val2			=20.0;$end_Val2		=$begin_Val2;$len_Val2		=1;
#$begin_Val2			=20.5;$end_Val2		=30.0;$len_Val2				=11;
#$begin_Val2			=5.0;$end_Val2		=20.0;$len_Val2				=11;	
...
#$begin_Val11	=0;$end_Val11	=10;$len_Val11	=11;
...
#$begin_Val37	=200.0;$end_Val37=$begin_Val37;$len_Val37=1;
...
if ($is_sigmaIi_linear == 0)
{
$val4 = $begin_Val4*(($end_Val4/$begin_Val4)**($l/($len_Val4 - 1.0)));
}
else
{
...
if ($is_sigmaWNI_linear == 0)
{
$val12 = $begin_Val12*(($end_Val12/$begin_Val12)**($t/($len_Val12 - 1.0)));
}
else
{
...
if ($is_gEI_linear == 0)
{
$val14 = $begin_Val14*(($end_Val14/$begin_Val14)**($v/($len_Val14 - 1.0)));
}
else
{
...
#if ($N_e > 0){$g_syn_AMPA_on_E=$val21*sqrt($N_pyr_sim/$N_e);}else{$g_syn_AMPA_on_E=$val21;}
#if ($N_e > 0){$g_syn_AMPA_on_I=$val14*sqrt($N_pyr_sim/$N_e);}else{$g_syn_AMPA_on_I=$val14;}
#if ($N_i > 0){$g_syn_GABA_on_E=$val15*$N_basket_sim/$N_i;}else{$g_syn_GABA_on_E=$val15;}
#if ($N_i > 0){$g_syn_GABA_on_I=$val2*$N_basket_sim/$N_i;}else{$g_syn_GABA_on_I=$val2;}

#$E_firing_rate = 40.0; #Hz
#$E_firing_rate = 5.4; #Hz
#$Gamma_freq = 40.0; #Hz

#$g_syn_AMPA_on_E=$g_syn_AMPA_on_E*$N_pyr_sim*$p_EE;
#$g_syn_AMPA_on_I=$g_syn_AMPA_on_I*$N_pyr_sim*$p_EI;

#$g_syn_AMPA_on_E=($g_syn_AMPA_on_E*$N_pyr_sim*$tmp_p_EE*$E_firing_rate)/$Gamma_freq;
#$g_syn_AMPA_on_I=$g_syn_AMPA_on_I*$N_pyr_sim*$tmp_p_EI*$E_firing_rate/$Gamma_freq;

#$g_syn_GABA_on_E=$g_syn_GABA_on_E*$N_basket_sim*$tmp_p_IE;
#$g_syn_GABA_on_I=$g_syn_GABA_on_I*$N_basket_sim*$tmp_p_II;
...
#$g_syn_II_gap_junction=$g_syn_II_gap_junction*1000.0*0.004/($N_i*$p_II_gap_junction);
...
#$FN=$REG_TAG."EEEIIEII_ING_gIEx${g_syn_GABA_on_E}_gIIx${g_syn_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEEIIEII_IappEx${Iapp_E}_sigmaIixi${l}_${begin_Val4}_${end_Val4}_${len_Val4}_sigmaWNE${sigma_white_noise_E}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEEIIEII_IappEx${Iapp_E}_sigmaWNIxi${t}_${begin_Val12}_${end_Val12}_${len_Val12}_sigmaWNE${sigma_white_noise_E}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEEIIEII_IappEx${Iapp_E}_sigmaIeEx${sigma_Ie_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEEIIEII_IappEx${Iapp_E}_gEIxi${v}_${begin_Val14}_${end_Val14}_${len_Val14}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
...
#$FN=$REG_TAG."test1_E2I_IappI${Iapp_I}";
#$FN=$REG_TAG."test1_E2I_IappI${Iapp_I}_2";
#$FN=$REG_TAG."test1_E2I_IappI${Iapp_I}_rndV${rnd_init_V}";
#$FN=$REG_TAG."test3";
...
#$FN=$REG_TAG."EEIEII_IappIx${Iapp_I}_IappE${Iapp_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";

#$FN=$REG_TAG."EEEIIEII_IappIx${Iapp_I}_IappE${Iapp_E}_gIE${g_syn_GABA_on_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";

$FN=$REG_TAG."EEEIIEII_I0Ibegin180.6_I0Iend210.8_I0IN2_I0Itbegin100_I0Itint200_IappE${Iapp_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_tEnd${tEnd}";
#$FN=$REG_TAG."EEEIIEII_IappIx${Iapp_I}_IappE${Iapp_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
#$FN=$REG_TAG."EEEIIEII_IappI${Iapp_I}_IappE${Iapp_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
...
#$FN=$REG_TAG."II_gIIxi${j}_gIIGJx${val35}_${begin_Val2}_${end_Val2}_${len_Val2}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";

#$FN=$REG_TAG."EEEIIEII_dtx${dt}_IappE${Iapp_E}_IappI${Iapp_I}_MFRe${E_firing_rate}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}c_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."II_gIIxi${j}_${begin_Val2}_${end_Val2}_${len_Val2}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_gIIGJx${g_syn_II_gap_junction}_pIIGJ${p_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
...
#			$cmd="./hh_network_PING_ING_WB \"$MYFLAG_STR\" ";			
			$cmd="./hh_network_PING_ING_WB_incdec_I \"$MYFLAG_STR\" ";
			#$cmd="./hh_network_PING_ING_WB_PERIODIC_EXTERNAL_INPUTS \"$MYFLAG_STR\" ";			
			system($cmd);
			#while (!(-e $done))
			#{
				#	sleep(1);
...
#			$cmd="nohup nice -n 19 ./hh_network_PING_ING_WB \"$MYFLAG_STR\" >nohup\"$done\".out 2>&1 &";
			$cmd="nohup nice -n 19 ./hh_network_PING_ING_WB_incdec_I \"$MYFLAG_STR\" >nohup\"$done\".out 2>&1 &";			
			#$cmd="nohup nice -n 19 ./hh_network_PING_ING_WB_PERIODIC_EXTERNAL_INPUTS \"$MYFLAG_STR\" >nohup\"$done\".out 2>&1 &";			
			system($cmd);
		}
