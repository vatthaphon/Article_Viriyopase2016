...
$begin_Val1			=1828.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
...
$begin_Val12		=0.1;$end_Val12		=1.0;$len_Val12			=2;$is_use_sigma_white_noise=1;
...
$FN=$REG_TAG."BW_NEWII_sigmaWNIx${sigma_white_noise_I}_sigmaWNE${sigma_white_noise_E}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
