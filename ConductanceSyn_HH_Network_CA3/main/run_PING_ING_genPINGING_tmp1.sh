...
if ($host eq "patron")
{
$mjob_file = "./mjob_RAP_patron.sh";
$store_dir = "/local/";      
}
else
{
$mjob_file = "./mjob_RAP.sh";
...
#$begin_Val17		=0;$end_Val17		=25.0;$len_Val17			=11;$is_use_sigma_white_noise=1;
...
#$begin_Val12		=20.0;$end_Val12	=$begin_Val12;$len_Val12	=1;$is_use_sigma_white_noise=1;
$begin_Val12		=0.0;$end_Val12		=25.0;$len_Val12			=11;$is_use_sigma_white_noise=1;
...
#$begin_Val14		=0.01;$end_Val14			=6.150*2.0;$len_Val14		=41;$is_gEI_linear = 0;	
...
#$begin_Val2			=0.0;$end_Val2		=20.0;$len_Val2				=101;
...
######## $rnd_white_noise_E
$begin_Val42		=0;$end_Val42		=$begin_Val42;$len_Val42	=1;
#$begin_Val42		=0;$end_Val42		=10;$len_Val42	=11;

######## $rnd_white_noise_I
#$begin_Val43		=0;$end_Val43		=$begin_Val43;$len_Val43	=1;
$begin_Val43		=0;$end_Val43		=10;$len_Val43	=11;
...
if ($len_Val43 > 1){$tmp = $end_Val43 - $begin_Val43;$tmp1 = $len_Val43 - 1;$dx_Val43 = $tmp/$tmp1;}else{$dx_Val43 = 0;}
...
$val43 = $begin_Val43 + $h17*$dx_Val43;
	
$rnd_white_noise_E = $val42;
$rnd_white_noise_I = $val43;
...
$FN="I_cells_intrinsic_dynamics_sigmaWNIx${sigma_white_noise_I}_rndWNIx${rnd_white_noise_I}_IappI${Iapp_I}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN="E_cells_intrinsic_dynamics_sigmaWNEx${sigma_white_noise_E}_rndWNEx${rnd_white_noise_E}_IappE${Iapp_E}_dt${dt}_tEnd${tEnd}_Ne${N_e}";
#$FN="E_I_cells_intrinsic_dynamics_IappEx${Iapp_E}_IappIx${Iapp_I}_sigmaWNEx${sigma_white_noise_E}_sigmaWNIx${sigma_white_noise_I}";
#$FN=$REG_TAG."EEEIIEII_gIIxi${j}_sigmaWNIxi${t}_${begin_Val2}_${end_Val2}_${len_Val2}_${begin_Val12}_${end_Val12}_${len_Val12}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."EEEIIEII_gIIxi${j}_sigmaIixi${l}_${begin_Val2}_${end_Val2}_${len_Val2}_${begin_Val4}_${end_Val4}_${len_Val4}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."EEEIIEII_gIIGJx${g_syn_II_gap_junction}_sigmaIixi${l}_${begin_Val4}_${end_Val4}_${len_Val4}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."EEEIIEII_gIIGJx${g_syn_II_gap_junction}_sigmaWNIxi${t}_${begin_Val12}_${end_Val12}_${len_Val12}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."EEEIIEII_gIIxi${j}_sigmaWNIxi${t}_${begin_Val2}_${end_Val2}_${len_Val2}_${begin_Val12}_${end_Val12}_${len_Val12}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."EEEIIEII_gIIxi${j}_gIIGJx${g_syn_II_gap_junction}_${begin_Val2}_${end_Val2}_${len_Val2}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
