...
$store_dir = "/vol/neuroinf2/viriyopa/scratch/";	
}
...
#$begin_Val1			=127.0;$end_Val1		=321.0;$len_Val1			=11;
#$begin_Val1			=90.0;$end_Val1		=300.0;$len_Val1			=21;
...
#$begin_Val2			=0.031271916611281;$end_Val2		=$begin_Val2;$len_Val2		=1;
#$begin_Val2			=0.305818319893139;$end_Val2		=$begin_Val2;$len_Val2		=1;
#$begin_Val2			=0.54207;$end_Val2		=$begin_Val2;$len_Val2		=1;
#$begin_Val2			=0.790846592093324;$end_Val2		=$begin_Val2;$len_Val2		=1;
#$begin_Val2			=1.398522626590596;$end_Val2		=$begin_Val2;$len_Val2		=1;
#$begin_Val2			=2.045130365127145;$end_Val2		=$begin_Val2;$len_Val2		=1;
#$begin_Val2			=9.352484478226215;$end_Val2		=$begin_Val2;$len_Val2		=1;
...
#$begin_Val11		=0;$end_Val11		=9;$len_Val11	=10;
...
#$begin_Val37	=1000.0;$end_Val37=$begin_Val37;$len_Val37=1;
...
$g_syn_GABA_on_I=$g_syn_GABA_on_I*1000.0*0.3/($N_i*$p_II);
...
$FN="WB_test_gIIx${g_syn_GABA_on_I}_pII${p_II}_IappI${Iapp_I}_Ni${N_i}";
...
####################### Send commands #######################	
	...
	else
	{
		...
		if ($wait2see == 1)
		{
			$cmd="./hh_network_PING_ING_CA3_NWB \"$MYFLAG_STR\" ";
			system($cmd);
			while (!(-e $done))
			{
				sleep(1);
		...
		{
			$cmd="nohup nice -n 19 ./hh_network_PING_ING_CA3_NWB \"$MYFLAG_STR\" >nohup\"$done\".out 2>&1 &";
			system($cmd);
		}
