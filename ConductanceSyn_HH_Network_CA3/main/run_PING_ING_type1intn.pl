...
#$begin_Val1			=216.6;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
...
#$begin_Val1			=162.0;$end_Val1		=253.0;$len_Val1			=11;
...
#$begin_Val4			=10.0;$end_Val4		=40.0;$len_Val4	=11;$is_hetero_Ie_I = 1;
...
#$begin_Val17		=30.0;$end_Val17	=$begin_Val17;$len_Val17	=1;$is_use_sigma_white_noise=1;
$begin_Val17		=30.0;$end_Val17	=45.0;$len_Val17			=11;$is_use_sigma_white_noise=1;
...
$begin_Val12		=1.0;$end_Val12		=2.0;$len_Val12			=11;$is_use_sigma_white_noise=1;
#$begin_Val12		=0.0;$end_Val12		=0.5;$len_Val12			=41;$is_use_sigma_white_noise=1;$is_sigmaWNI_linear = 0;
...
#$begin_Val15		=30.0;$end_Val15=$begin_Val15;$len_Val15=1;	# Bal.
...
#$is_use_GSL_2_solve_ODE = 0;
#$begin_Val10=0.06;$end_Val10=$begin_Val10;$len_Val10=1;		# dt = 0.001 to get close to GSL results

#$begin_Val10=0.2;$end_Val10=0.4;$len_Val10=3;		# dt = 0.001 to get close to GSL results
}
...
#$FN=$REG_TAG."WB_EEEIIEII_sigmaIex${sigma_Ie_E}_sigmaIix${sigma_Ie_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
#$FN=$REG_TAG."WB_EEEIIEII_sigmaWNEx${sigma_white_noise_E}_sigmaWNIx${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";

#$FN=$REG_TAG."WB_EEIEII_sigmaIex${sigma_Ie_E}_sigmaIix${sigma_Ie_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
$FN=$REG_TAG."WB_EEIEII_sigmaWNEx${sigma_white_noise_E}_sigmaWNIx${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";

#$FN=$REG_TAG."EEEIIEII_sigmaWNIx${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
#$FN=$REG_TAG."EEEIIEII_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
...
#$FN=$REG_TAG."EEEIIEII_dtx${dt}_IappE${Iapp_E}_IappI${Iapp_I}_MFRe${E_firing_rate}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
