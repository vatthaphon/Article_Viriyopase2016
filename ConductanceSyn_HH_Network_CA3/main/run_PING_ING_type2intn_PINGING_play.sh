...
#$begin_Val1			=1175.0;$end_Val1		=1385.0;$len_Val1			=11;
...
$begin_Val17		=0.0;$end_Val17		=25.0;$len_Val17			=51;$is_use_sigma_white_noise=1;
...
$FN=$REG_TAG."BW_EEEIIEII_IappEx${Iapp_E}_sigmaWNEx${sigma_white_noise_E}_IappI${Iapp_I}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEIEII_IappEx${Iapp_E}_sigmaWNEx${sigma_white_noise_E}_IappI${Iapp_I}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
