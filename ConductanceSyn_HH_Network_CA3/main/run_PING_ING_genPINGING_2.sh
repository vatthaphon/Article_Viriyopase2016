...
$FN=$REG_TAG."EEEIIEII_gIEx${g_syn_GABA_on_E}_IappE${Iapp_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
