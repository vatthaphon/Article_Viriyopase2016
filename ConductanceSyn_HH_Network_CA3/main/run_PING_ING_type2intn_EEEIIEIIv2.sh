...
$begin_Val13		=2200;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
#$begin_Val13		=0.0;$end_Val13		=2200.0;$len_Val13			=11;				
...
#$begin_Val1			=1265.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
#$begin_Val1			=1807.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
...
#$FN=$REG_TAG."BW_EEEIIEII_sigmaWNEx${sigma_white_noise_E}_sigmaWNIx${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
...
$FN=$REG_TAG."BW_EEEIIEII_sigmaWNEx${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
