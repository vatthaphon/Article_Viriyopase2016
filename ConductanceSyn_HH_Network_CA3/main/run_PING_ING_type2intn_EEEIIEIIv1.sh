...
$begin_Val12		=0.0;$end_Val12		=1.0;$len_Val12			=41;$is_use_sigma_white_noise=1;
...
$FN=$REG_TAG."BW_EEEIIEII_sigmaWNIx${sigma_white_noise_I}_sigmaWNE${sigma_white_noise_E}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
