...
#$begin_Val13		=337.5;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
...
#$begin_Val16		=925.0;$end_Val16		=$begin_Val16;$len_Val16	=1;$is_hetero_Ie_E = 1;
...
$FN=$REG_TAG."EEEIIEII_IappEx${Iapp_E}_sigmaIeEx${sigma_Ie_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndCon${rnd_determineConnections}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
...
####################### Send commands #######################	
	...
	else
	{
		...
		{
			$cmd="nohup nice -n 19 ./hh_network_PING_ING_CA3_NWB \"$MYFLAG_STR\" >z_tmp_Output\"$done\".out 2>&1 &";
			system($cmd);
		}
