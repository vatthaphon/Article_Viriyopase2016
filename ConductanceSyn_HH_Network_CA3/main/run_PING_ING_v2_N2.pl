...
#$begin_Val13		=0.0;$end_Val13		=500.0;$len_Val13			=41;				
...
#$begin_Val4			=0.0;$end_Val4		=10.0;$len_Val4	=11;$is_hetero_Ie_I = 1;
...
#$begin_Val12		=0.0;$end_Val12		=1.0;$len_Val12			=11;$is_use_sigma_white_noise=1;
...
######## tau_d_GABA_on_E
$begin_Val27		=4.0;$end_Val27	=$begin_Val27;$len_Val27	=1;
...
#$begin_Val27		=4.5;$end_Val27		=8.0;$len_Val27				=11;
#$begin_Val27		=3.5;$end_Val27		=4.5;$len_Val27				=11;
...
#$begin_Val9			=1.9;$end_Val9		=2.5;$len_Val9				=11;
...
$E_firing_rate = 1.9663; #Hz
$I_firing_rate = 35.6977; #Hz
$Gamma_freq = 38.0001; #Hz
...
#$begin_Val15		=22.0;$end_Val15		=30.0;$len_Val15		=5;
...
$begin_Val2				=20.0;$end_Val2		=$begin_Val2;$len_Val2		=1;	# Default gII
#$begin_Val2			=10.0;$end_Val2			=20.0;$len_Val2		=6;

#$begin_Val2			=10.0;$end_Val2			=20.0;$len_Val2		=11;
#$begin_Val2			=10.0;$end_Val2			=20.0;$len_Val2		=11;
#$begin_Val2			=12.0;$end_Val2		=20.0;$len_Val2				=11;
...
$is_use_GSL_2_solve_ODE = 1;$begin_Val10=0.0001;$end_Val10=$begin_Val10;$len_Val10=1;			# For GSL, dt = 0.05 is not so different from dt = 0.01.
}
else
{
#$is_use_GSL_2_solve_ODE = 0;$begin_Val10=0.01;$end_Val10=$begin_Val10;$len_Val10=1;		# dt = 0.001 to get close to GSL results		
$is_use_GSL_2_solve_ODE = 0;$begin_Val10=0.0001;$end_Val10=$begin_Val10;$len_Val10=1;		# dt = 0.001 to get close to GSL results
}
...
#$begin_Val37	=4000.0;$end_Val37=$begin_Val37;$len_Val37=1;
...
$tmp_g_syn_AMPA_on_E=$g_syn_AMPA_on_E;
$tmp_g_syn_AMPA_on_I=$g_syn_AMPA_on_I;
$tmp_g_syn_GABA_on_E=$g_syn_GABA_on_E;
$tmp_g_syn_GABA_on_I=$g_syn_GABA_on_I;

$g_syn_AMPA_on_E=($g_syn_AMPA_on_E*$N_pyr*$tmp_p_EE*$E_firing_rate)/$Gamma_freq;
$g_syn_AMPA_on_I=($g_syn_AMPA_on_I*$N_pyr*$tmp_p_EI*$E_firing_rate)/$Gamma_freq;

$g_syn_GABA_on_E=($g_syn_GABA_on_E*$N_basket*$tmp_p_IE*$I_firing_rate)/$Gamma_freq;
$g_syn_GABA_on_I=($g_syn_GABA_on_I*$N_basket*$tmp_p_II*$I_firing_rate)/$Gamma_freq;
...
#$FN=$REG_TAG."WB_EEEIIEII_sigmaWNEx${sigma_white_noise_E}_sigmaWNIx${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."WB_EEIEII_sigmaWNEx${sigma_white_noise_E}_sigmaWNIx${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."EEEIIEII_sigmaIex${sigma_Ie_E}_sigmaIix${sigma_Ie_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEIEII_sigmaIex${sigma_Ie_E}_sigmaIix${sigma_Ie_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."EEIEII_gIEx${g_syn_GABA_on_E}_gIIx${g_syn_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEEIIEII_gIEx${g_syn_GABA_on_E}_gIIx${g_syn_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."EEIEII_gIE${tmp_g_syn_GABA_on_E}_gII${tmp_g_syn_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
$FN=$REG_TAG."EEEIIEII_gIE${tmp_g_syn_GABA_on_E}_gII${tmp_g_syn_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."EEEIIEII_tauDIEx${tau_d_GABA_on_E}_tauDIIx${tau_d_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEIEII_tauDIEx${tau_d_GABA_on_E}_tauDIIx${tau_d_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."BW_EEIEII_gIIxi${j}_gIIGJx${g_syn_II_gap_junction}_${begin_Val2}_${end_Val2}_${len_Val2}_IappI${Iapp_I}_IappE${Iapp_E}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
