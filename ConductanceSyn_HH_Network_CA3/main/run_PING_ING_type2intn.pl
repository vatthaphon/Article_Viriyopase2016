...
#$begin_Val4			=1000.0;$end_Val4		=2000.0;$len_Val4	=11;$is_hetero_Ie_I = 1;
...
#$begin_Val12		=0.25;$end_Val12	=$begin_Val12;$len_Val12	=1;$is_use_sigma_white_noise=1;
#$begin_Val12		=0.5;$end_Val12	=$begin_Val12;$len_Val12	=1;$is_use_sigma_white_noise=1;
$begin_Val12		=1.5;$end_Val12		=10.0;$len_Val12			=11;$is_use_sigma_white_noise=1;
...
#$begin_Val15		=0.0;$end_Val15		=50.0;$len_Val15		=11;	
...
$FN=$REG_TAG."BW_EEEIIEII_sigmaWNEx${sigma_white_noise_E}_sigmaWNIx${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";

#$FN=$REG_TAG."BW_EEIEII_sigmaIex${sigma_Ie_E}_sigmaIix${sigma_Ie_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
#$FN=$REG_TAG."BW_EEIEII_sigmaWNEx${sigma_white_noise_E}_sigmaWNIx${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
...
#$FN=$REG_TAG."BW_II_gIIxi${j}_gIIGJx${g_syn_II_gap_junction}_${begin_Val2}_${end_Val2}_${len_Val2}_IappI${Iapp_I}_IappE${Iapp_E}_sigmaWNI${sigma_white_noise_I}_sigmaWNE${sigma_white_noise_E}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
