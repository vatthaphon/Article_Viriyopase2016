...
$store_dir = "/vol/neuroinf2/viriyopa/scratch/tmp70/";
...
#$begin_Val13		=1258.9;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
$begin_Val13		=3548.1;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
#$begin_Val13		=750.0;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
#$begin_Val13		=0.0;$end_Val13		=5000.0;$len_Val13			=11;				
...
#$begin_Val16		=0.0;$end_Val16		=3000.0;$len_Val16	=11;$is_hetero_Ie_E = 1;
...
#$begin_Val1			=1175.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.

$begin_Val1			=1355.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
...
#$begin_Val4			=0.0;$end_Val4		=100.0;$len_Val4	=11;$is_hetero_Ie_I = 1;
...
$begin_Val12		=0.0;$end_Val12		=1.5;$len_Val12			=11;$is_use_sigma_white_noise=1;
...
#$begin_Val27		=8.0;$end_Val27		=$begin_Val27;$len_Val27	=1;
#$begin_Val27		=3.5;$end_Val27		=3.5;$len_Val27	=1;
#$begin_Val27		=3.1;$end_Val27		=8.0;$len_Val27				=11;

######## tau_d_GABA_on_I
$begin_Val9			=2.0;$end_Val9		=$begin_Val9;$len_Val9		=1;
#$begin_Val9			=4.0;$end_Val9		=$begin_Val9;$len_Val9		=1;
#$begin_Val9			=1.9;$end_Val9		=4.0;$len_Val9				=11;
...
#$begin_Val15		=15.0;$end_Val15		=25.0;$len_Val15		=11;	
...
#$begin_Val2			=8.0;$end_Val2		=20.0;$len_Val2				=11;
...
$FN=$REG_TAG."EEIEII_sigmaWNEx${sigma_white_noise_E}_sigmaWNIx${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
...
#$FN=$REG_TAG."BW_EEIEII_gIEx${g_syn_GABA_on_E}_gIIx${g_syn_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEEIIEII_gIEx${g_syn_GABA_on_E}_gIIx${g_syn_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."BW_EEEIIEII_tauDIEx${tau_d_GABA_on_E}_tauDIIx${tau_d_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEIEII_tauDIEx${tau_d_GABA_on_E}_tauDIIx${tau_d_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."BW_EEEIIEII_tauDIEx${tau_d_GABA_on_E}_tauDIIx${tau_d_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."BW_EEEIIEII_sigmaIex${sigma_Ie_E}_sigmaIix${sigma_Ie_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
...
#$FN=$REG_TAG."BW_EEIEII_IappE${Iapp_E}_IappIx${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
