...
#$begin_Val1			=-115.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron
#$begin_Val1			=5000.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Max current					
$begin_Val1			=-115.0;$end_Val1		=5000.0;$len_Val1			=5116;
...
#$begin_Val35		=0.0;$end_Val35		=1.5;$len_Val35				=11;
...
$FN=$REG_TAG."IappIx${Iapp_I}_dt${dt}_tEnd${tEnd}";
...
#$FN=$REG_TAG."II_IappIx${Iapp_I}_gIIGJx${val35}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
