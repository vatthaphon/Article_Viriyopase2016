...
$store_dir = "/vol/neuroinf/viriyopa/scratch/tmp12/";	
}
...
#$begin_Val13		=2400.0;$end_Val13=$begin_Val13;$len_Val13=1;
#$begin_Val13		=19000.0;$end_Val13=$begin_Val13;$len_Val13=1;

#$begin_Val13		=0.0;$end_Val13		=300000.0;$len_Val13			=11;
$begin_Val13		=2400.0;$end_Val13		=30000.0;$len_Val13			=11;
...
#$begin_Val1			=1200.0;$end_Val1		=1580.0;$len_Val1			=11;
...
#$E_firing_rate = 0.01; #Hz
$E_firing_rate = 5.0; #Hz
$Gamma_freq = 40.0; #Hz
...
#$FN=$REG_TAG."BW_EEEIIEII_IappEx${Iapp_E}_IappIx${Iapp_I}_weak_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEIEII_IappEx${Iapp_E}_IappIx${Iapp_I}_weak_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEEIIEII_IappEx${Iapp_E}_IappI${Iapp_I}_weak_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."BW_EEEIIEII_IappEx${Iapp_E}_IappIx${Iapp_I}_MFRe${E_firing_rate}_weak_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEIEII_IappEx${Iapp_E}_IappIx${Iapp_I}_MFRe${E_firing_rate}_weak_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
$FN=$REG_TAG."BW_EEEIIEII_IappEx${Iapp_E}_IappI${Iapp_I}_MFRe${E_firing_rate}_weak_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
