...
$tau_m_i     =10;        # !! no more for HH neurons, Membrane time constants [ms]
...
if ($host eq "patron")
{
$mjob_file = "./mjob_RAP_patron_type1int.sh";
$store_dir = "/local/";      
}
else
{
$mjob_file = "./mjob_RAP_type1int.sh";
...
#$begin_Val13		=200.0;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
#$begin_Val13		=0.0;$end_Val13		=1000.0;$len_Val13			=11;				
...
#$begin_Val16		=0.0;$end_Val16		=50.0;$len_Val16	=11;$is_hetero_Ie_E = 1;

######## Iapp_I, [Iapp_I] = pA
$is_Iapp_I_linear = 1;
#$begin_Val1			=0.0;$end_Val1		=$begin_Val1;$len_Val1		=1;
$begin_Val1			=200.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
#$begin_Val1			=146.0;$end_Val1		=980.0;$len_Val1			=11;
#$begin_Val1			=10.0;$end_Val1		=146.0;$len_Val1			=11;
#$begin_Val1			=105.0;$end_Val1		=120.0;$len_Val1			=101;
#$begin_Val1			=100.0;$end_Val1		=1000.0;$len_Val1			=11;
#$begin_Val1			=100.0;$end_Val1		=1000.0;$len_Val1			=41;
#$begin_Val1			=90.0;$end_Val1		=300.0;$len_Val1		=41;$is_Iapp_I_linear = 0;
...
#$begin_Val4			=0.0;$end_Val4		=10.0;$len_Val4	=41;$is_hetero_Ie_I = 1;
...
#$begin_Val17		=20.0;$end_Val17	=$begin_Val17;$len_Val17	=1;$is_use_sigma_white_noise=1;
#$begin_Val17		=0.0;$end_Val17		=20.0;$len_Val17			=11;$is_use_sigma_white_noise=1;

######## sigma_white_noise_I
#$begin_Val12		=0.0;$end_Val12		=$begin_Val12;$len_Val12	=1;
$begin_Val12		=10.0;$end_Val12	=$begin_Val12;$len_Val12	=1;$is_use_sigma_white_noise=1;
#$begin_Val12		=0.0;$end_Val12		=0.8;$len_Val12			=41;$is_use_sigma_white_noise=1;
...
#$begin_Val38		=2.0;$end_Val38		=3.0;$len_Val38		=5;
...
#$begin_Val7			=0.0;$end_Val7		=$begin_Val7;$len_Val7		=1;
#$begin_Val7			=0.5;$end_Val7		=0.5;$len_Val7		=1;
#$begin_Val7		=0.0;$end_Val7		=1.0;$len_Val7		=21;
...
#$begin_Val39		=0.1;$end_Val39		=1.1;$len_Val39		=11;

######## tau_r_AMPA_on_I
$begin_Val23		=0.45;$end_Val23	=$begin_Val23;$len_Val23	=1;
#$begin_Val23		=0.1;$end_Val23		=$begin_Val23;$len_Val23	=1;
#$begin_Val23		=0.1;$end_Val23		=0.1;$len_Val23	=1;
#$begin_Val23		=0.1;$end_Val23		=0.6;$len_Val23		=5;
...
#$begin_Val8			=0.1;$end_Val8		=0.5;$len_Val8				=21;
...
#$begin_Val40		=2.0;$end_Val40		=3.0;$len_Val40		=11;
...
#$begin_Val9			=1.5;$end_Val9		=2.5;$len_Val9				=41;
#$begin_Val9			=1.5;$end_Val9		=10.0;$len_Val9				=41;
...
#$begin_Val14		=0.0;$end_Val14			=12.0;$len_Val14		=6;	
...
#$begin_Val2			=0.0;$end_Val2		=20.0;$len_Val2				=41;
#$begin_Val2			=0.01;$end_Val2		=20.0;$len_Val2				=11;$is_gII_linear = 0;
#$begin_Val2			=0.01;$end_Val2		=100.0;$len_Val2				=101;$is_gII_linear = 0;
...
#$begin_Val3			=0.0001;$end_Val3		=0.4;$len_Val3		=41;$is_pII_linear = 0;
...
#$begin_Val35		=0.0;$end_Val35		=4.0;$len_Val35				=11;
#$begin_Val35		=0.0;$end_Val35		=10.0;$len_Val35			=11;
...
#$begin_Val31		=1.0;$end_Val31	=$begin_Val31;$len_Val31	=1;
#$begin_Val31		=0.001;$end_Val31	=0.01;$len_Val31	=21;
#$begin_Val31		=0.001;$end_Val31		=0.02;$len_Val31	=41;$is_pGJII_linear = 0;
...
#$begin_Val11		=1;$end_Val11		=$begin_Val11;$len_Val11	=1;
$begin_Val11		=0;$end_Val11		=40;$len_Val11	=41;

######## rnd_white_noise_I = 1;
$begin_Val42		=0;$end_Val42		=40;$len_Val42	=41;

######## rnd_determineConnections
$rnd_determineConnections = 1;
#$rnd_determineConnections = 0;
...
#$begin_Val37	=6000.0;$end_Val37=$begin_Val37;$len_Val37=1;
#$begin_Val37	=10000.0;$end_Val37=$begin_Val37;$len_Val37=1;
#$begin_Val37	=20000.0;$end_Val37=$begin_Val37;$len_Val37=1;
...
if ($len_Val42 > 1){$tmp = $end_Val42 - $begin_Val42;$tmp1 = $len_Val42 - 1;$dx_Val42 = $tmp/$tmp1;}else{$dx_Val42 = 0;}
...
$val42 = $begin_Val42 + $h16*$dx_Val42;
	
$rnd_white_noise_I = $val42; 	
$wb_g_L = $val41;
...
#$FN=$REG_TAG."II_pIIGJxi${h5}_sigmaIeIx${sigma_Ie_I}_${begin_Val31}_${end_Val31}_${len_Val31}_gII${g_syn_GABA_on_I}_gIIGJ${g_syn_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_rndRmIe${rnd_init_RmIe_seed}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_gIIGJx${g_syn_II_gap_junction}_sigmaIeIx${sigma_Ie_I}_gII${g_syn_GABA_on_I}_pIIGJ${p_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_rndRmIe${rnd_init_RmIe_seed}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_gIIGJx${g_syn_II_gap_junction}_sigmaWNIx${sigma_white_noise_I}_gII${g_syn_GABA_on_I}_pIIGJ${p_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_pIIGJxi${h5}_sigmaWNIx${sigma_white_noise_I}_${begin_Val31}_${end_Val31}_${len_Val31}_gII${g_syn_GABA_on_I}_gIIGJ${g_syn_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_gIIxi${j}_gIIGJx${g_syn_II_gap_junction}_sigmaWNIx${sigma_white_noise_I}_${begin_Val2}_${end_Val2}_${len_Val2}_pIIGJ${p_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_gIIxi${j}_gIIGJx${g_syn_II_gap_junction}_${begin_Val2}_${end_Val2}_${len_Val2}_fixedGJ_sigmaWNI${sigma_white_noise_I}_pIIGJ${p_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_gIIxi${j}_gIIGJx${g_syn_II_gap_junction}_${begin_Val2}_${end_Val2}_${len_Val2}_lIIx${tau_l_GABA_on_I}_sigmaWNI${sigma_white_noise_I}_pIIGJ${p_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_gIIxi${j}_gIIGJx${g_syn_II_gap_junction}_${begin_Val2}_${end_Val2}_${len_Val2}_lIIx${tau_l_GABA_on_I}_sigmaWNI${sigma_white_noise_I}_pIIGJ${p_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_pIIxi${k}_pIIGJxi${h5}_${begin_Val3}_${end_Val3}_${len_Val3}_${begin_Val31}_${end_Val31}_${len_Val31}_sigmaWNI${sigma_white_noise_I}_gIIGJ${g_syn_II_gap_junction}_gII${g_syn_GABA_on_I}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_sigmaWNIx${sigma_white_noise_I}_pII${p_II}_pIIGJ${p_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_IappIx${Iapp_I}_sigmaWNIx${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_IappIx${Iapp_I}_gIIx${g_syn_GABA_on_I}_gGJ${g_syn_II_gap_junction}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";

#$FN=$REG_TAG."II_gIIxi${j}_gIIGJx${g_syn_II_gap_junction}_${begin_Val2}_${end_Val2}_${len_Val2}_sigmaWNI${sigma_white_noise_I}_pII${p_II}_pIIGJ${p_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
...
#$FN=$REG_TAG."EEEIIEII_IappEx${Iapp_E}_IappIx${Iapp_I}_sigmaWNE${sigma_white_noise_E}_pEI${p_EI}_pII${p_II}_pIIGJ${p_II_gap_junction}_dt${dt}_tEnd${tEnd}_Ne${N_e}_Ni${N_i}";
...
#$FN=$REG_TAG."II_IappIx${Iapp_I}_sigmaWNI${sigma_white_noise_I}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_gIIx${g_syn_GABA_on_I}_IappI${Iapp_I}_sigmaWNI${sigma_white_noise_I}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_tauDIIx${tau_d_GABA_on_I}_IappI${Iapp_I}_sigmaWNI${sigma_white_noise_I}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_sigmaWNIx${sigma_white_noise_I}_IappI${Iapp_I}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_sigmaIeIx${sigma_Ie_I}_sigmaWNI${sigma_white_noise_I}_IappI${Iapp_I}_dt${dt}_tEnd${tEnd}_Ni${N_i}";

#$FN=$REG_TAG."II_gIIxi${j}_gIIGJx${g_syn_II_gap_junction}_${begin_Val2}_${end_Val2}_${len_Val2}_IappI${Iapp_I}_IappE${Iapp_E}_sigmaWNI${sigma_white_noise_I}_sigmaWNE${sigma_white_noise_E}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."II_gIIxi${j}_gIIGJx${g_syn_II_gap_junction}_${begin_Val2}_${end_Val2}_${len_Val2}_rndV${rnd_init_V}_rndConn${rnd_determineConnections}_IappI${Iapp_I}_IappE${Iapp_E}_sigmaWNI${sigma_white_noise_I}_sigmaWNE${sigma_white_noise_E}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."II_IappIx${Iapp_I}_rndV${rnd_init_V}_rndConn${rnd_determineConnections}_sigmaWNI${sigma_white_noise_I}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
$FN=$REG_TAG."II_rndWhiteNoiseI${rnd_white_noise_I}_rndVx${rnd_init_V}_IappI${Iapp_I}_sigmaWNI${sigma_white_noise_I}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."II_IappIx${Iapp_I}_gIIGJx${g_syn_II_gap_junction}_sigmaWNI${sigma_white_noise_I}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_lIIx${tau_l_GABA_on_I}_rIIx${tau_r_GABA_on_I}_dIIx${tau_d_GABA_on_I}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}";
#$FN=$REG_TAG."II_gIIx${g_syn_GABA_on_I}_gIIGJx${g_syn_II_gap_junction}_${begin_Val2}_${end_Val2}_${len_Val2}_pIIGJ${p_II_gap_junction}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
...
#$FN=$REG_TAG."II_gIIxi${j}_IappI${Iapp_I}_${begin_Val2}_${end_Val2}_${len_Val2}_gIIGJ${g_syn_II_gap_junction}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
...
#$FN=$REG_TAG."II_IappIx${Iapp_I}_pIIGJx${p_II_gap_junction}_gII${g_syn_GABA_on_I}_pII${p_II}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
...
#$FN=$REG_TAG."II_IappIxi${i}_pIIGJx${p_II_gap_junction}_${begin_Val1}_${end_Val1}_${len_Val1}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_IappIx${Iapp_I}_pIIGJx${p_II_gap_junction}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
#$FN=$REG_TAG."II_IappIx${Iapp_I}_gII${g_syn_GABA_on_I}_pIIGJ${p_II_gap_junction}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
...
####################### Send commands #######################	
	...
	else
	{
		...
		if ($wait2see == 1)
		{
			$cmd="./hh_network_PING_ING_WB \"$MYFLAG_STR\" ";
			system($cmd);
			while (!(-e $done))
			{
				sleep(1);
		...
		{
			$cmd="nohup nice -n 19 ./hh_network_PING_ING_WB \"$MYFLAG_STR\" >nohup\"$done\".out 2>&1 &";
			system($cmd);
		}
