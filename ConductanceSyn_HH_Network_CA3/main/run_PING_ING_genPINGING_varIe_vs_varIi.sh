...
$begin_Val16		=400.0;$end_Val16		=600.0;$len_Val16	=11;$is_hetero_Ie_E = 1;
...
#$begin_Val17		=15.0;$end_Val17		=25.0;$len_Val17			=11;$is_use_sigma_white_noise=1;
...
#$begin_Val12		=0.0;$end_Val12		=0.8;$len_Val12			=11;$is_use_sigma_white_noise=1;
...
#$begin_Val2			=0.0001;$end_Val2		=20.0;$len_Val2				=51;$is_gII_linear = 0;
...
$FN=$REG_TAG."EEEIIEII_sigmaIeEx${sigma_Ie_E}_sigmaIeIx${sigma_Ie_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEEIIEII_sigmaWNEx${sigma_white_noise_E}_sigmaWNIx${sigma_white_noise_I}_IappE${Iapp_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
