...
#$begin_Val13		=216.0;$end_Val13=$begin_Val13;$len_Val13=1;					# Threshold current to excite a CA1 is around 110.0 pA and 1.459219739913300e+002 pA for CA3.
...
#$begin_Val13		=500.0;$end_Val13		=5000.0;$len_Val13			=11;				
#$begin_Val13		=0.0;$end_Val13		=5000.0;$len_Val13			=11;
$begin_Val13		=10;$end_Val13	=10000.0;$len_Val13			=21;$is_Iapp_E_linear = 0;
...
#$begin_Val1			=1175.0;$end_Val1		=1385.0;$len_Val1			=41;
$begin_Val1			=1175.0;$end_Val1		=2170.0;$len_Val1			=21;
...
#$begin_Val17		=100.0;$end_Val17	=$begin_Val17;$len_Val17	=1;$is_use_sigma_white_noise=1;
$begin_Val17		=60.0;$end_Val17	=$begin_Val17;$len_Val17	=1;$is_use_sigma_white_noise=1;
#$begin_Val17		=0.0;$end_Val17		=150.0;$len_Val17			=41;$is_use_sigma_white_noise=1;
...
#$begin_Val27		=1.0;$end_Val27		=$begin_Val27;$len_Val27	=1;
#$begin_Val27		=3.5;$end_Val27		=3.5;$len_Val27	=1;
#$begin_Val27		=1.0;$end_Val27		=8.0;$len_Val27				=51;
...
#$begin_Val2			=0.01;$end_Val2		=20.0;$len_Val2				=5;$is_gII_linear = 0;
...
#$FN=$REG_TAG."BW_EEEIIEII_IappEx${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEEIIEII_IappEx${Iapp_E}_IappIx${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEIEII_IappEx${Iapp_E}_IappIx${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."BW_EEEIIEII_IappExi${u}_${begin_Val13}_${end_Val13}_${len_Val13}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEEIIEII_IappExi${u}_IappIx${Iapp_I}_${begin_Val13}_${end_Val13}_${len_Val13}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
$FN=$REG_TAG."BW_EEIEII_IappExi${u}_IappIx${Iapp_I}_${begin_Val13}_${end_Val13}_${len_Val13}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."BW_EEEIIEII_IappExi${u}_sigmaWNEx${sigma_white_noise_E}_${begin_Val13}_${end_Val13}_${len_Val13}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."BW_EEEIIEII_IappEx${Iapp_E}_IappIx${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

#$FN=$REG_TAG."BW_EEIEII_gIIxi${j}_IappEx${Iapp_E}_${begin_Val2}_${end_Val2}_${len_Val2}_sigmaWNE${sigma_white_noise_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEIEII_IappEx${Iapp_E}_sigmaWNEx${sigma_white_noise_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEIEII_IappEx${Iapp_E}_IappIx${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."BW_EEEIIEII_tauDIEx${tau_d_GABA_on_E}_IappE${Iapp_E}_sigmaWNE${sigma_white_noise_E}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
