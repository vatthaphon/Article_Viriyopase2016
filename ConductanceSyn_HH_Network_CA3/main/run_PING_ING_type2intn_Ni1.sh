...
$begin_Val1			=1203.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
...
#$begin_Val2			=0.01;$end_Val2		=200.0;$len_Val2				=41;$is_gII_linear = 0;
...
#$begin_Val11	=0;$end_Val11	=20;$len_Val11	=21;
...
#$is_use_GSL_2_solve_ODE = 1;$begin_Val10=0.001;$end_Val10=$begin_Val10;$len_Val10=1;			# For GSL, dt = 0.05 is not so different from dt = 0.01.
#}
#else
#{
...
#$FN=$REG_TAG."BW_IappIx${Iapp_I}_Ni${N_i}";
$FN=$REG_TAG."test2";
