...
$begin_Val14		=6.0;$end_Val14			=50.0;$len_Val14		=11;	

######## g_syn_GABA_on_E, gI->E
#$begin_Val15		=24.06;$end_Val15	=$begin_Val15;$len_Val15	=1;	# Default gIE

$begin_Val15		=40.0;$end_Val15	=$begin_Val15;$len_Val15	=1;	# Bal.
...
$begin_Val2				=30.0;$end_Val2		=$begin_Val2;$len_Val2		=1;	# Default gII
...
#$FN=$REG_TAG."EEIEII_gIE${g_syn_GABA_on_E}_gII${g_syn_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEEIIEII_gIE${g_syn_GABA_on_E}_gII${g_syn_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";

$FN=$REG_TAG."EEEIIEII_gEIx${g_syn_AMPA_on_I}_gIE${g_syn_GABA_on_E}_gII${g_syn_GABA_on_I}_IappE${Iapp_E}_IappI${Iapp_I}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
