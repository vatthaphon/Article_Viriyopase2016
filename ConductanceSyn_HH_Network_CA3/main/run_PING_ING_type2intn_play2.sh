...
#$begin_Val17		=0.1;$end_Val17	=150.0;$len_Val17			=11;$is_use_sigma_white_noise=1;$is_sigmaWNE_linear = 0;
...
$begin_Val12		=0.0;$end_Val12		=0.5;$len_Val12			=41;$is_use_sigma_white_noise=1;
...
$FN=$REG_TAG."BW_II_sigmaWNIx${sigma_white_noise_I}_IappI${Iapp_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
