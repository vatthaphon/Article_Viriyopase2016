...
$begin_Val1			=180.0;$end_Val1=$begin_Val1;$len_Val1=1;					# Threshold current to excite a neuron is around 30.0 pA.
#$begin_Val1			=180.0;$end_Val1		=722.0;$len_Val1			=21;
...
#$begin_Val35		=0.1;$end_Val35		=$begin_Val35;$len_Val35	=1;
#$begin_Val35		=0.0;$end_Val35		=1.0;$len_Val35				=11;
...
$FN=$REG_TAG."II_IappIx${Iapp_I}_gIIGJ${val35}_rndVx${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}";
