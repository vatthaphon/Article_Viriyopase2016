...
$begin_Val16		=400.0;$end_Val16		=600.0;$len_Val16	=41;$is_hetero_Ie_E = 1;
...
#$begin_Val17		=15.0;$end_Val17	=25.0;$len_Val17			=41;$is_use_sigma_white_noise=1;
...
#$begin_Val12		=0.0;$end_Val12		=5.0;$len_Val12			=41;$is_use_sigma_white_noise=1;
...
$FN=$REG_TAG."EEEIIEII_sigmaIeEx${sigma_Ie_E}_IappE${Iapp_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEEIIEII_sigmaWNEx${sigma_white_noise_E}_IappE${Iapp_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
#$FN=$REG_TAG."EEEIIEII_tauDIEx${tau_d_GABA_on_E}_IappE${Iapp_E}_sigmaWNE${sigma_white_noise_E}_sigmaWNI${sigma_white_noise_I}_rndV${rnd_init_V}_dt${dt}_tEnd${tEnd}_Ni${N_i}_Ne${N_e}";
